    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('home-admin') }}" class="nav-link">Inicio</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        @foreach ($notificacaoes as $item)
                            <a href="{{ route('web.admin.notificacoes', ['notification' => $item->id]) }}" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <img src="{{ public_path('assets/images/user.png') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('web.logout-administrator') }}" class="nav-link">Sair</a>
                </li>
            </ul>
        </nav>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{ route('home-admin') }}" class="d-block"> {{ Auth::user()->nome }}</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('listagem-escola') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('app.listagem-estudantes-geral') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('app.professores-index') }}" class="nav-link">
                   ...
                   {{-- <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('web.transferencia-escolares-professores') }}" class="nav-link">
                                <i class="fas fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('app.Dispanho-professores-index') }}" class="nav-link">
                                    <i class="fas fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('web.transferencia-escola-professores') }}" class="nav-link">
                                    <i class="fas fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('app.estatisticas-estudantes-geral') }}" class="nav-link">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>Estudantes</p>
                                </a>
                            </li> 
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('web.funcionarios-ministerio') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('web.departamento-ministerio') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Departamentos</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('web.cargos-ministerio') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Cargos</p>
                                </a>
                            </li>
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{ route('admin.modulos-shcools') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('web.ensinos') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Ensinos</p>
                                </a>
                            </li> --}}
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('app.privacidade') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('app.utilizadores-index') }}" class="nav-link">
                                    <i class="nav-icon fas fa-user-tie"></i>
                                    <p>Utilizadores</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('definicoes') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Definições</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('termos') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Termos</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('politicas') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Políticas</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('direccoes-provincias.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Direcção Provincial</p>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('logisticas.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Controle</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('web.fornecedores') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Fornecedores</p>
                                </a>
                            </li>
        ...
        <footer class="main-footer bg-dark">
            ...
            Versão do Sistema <strong>1.0</strong>
            </div> --}}
            <!-- Default to the left -->
            {{-- <strong>Copyright &copy; 2020-{{date('Y')}} <a href="https://free.facebook.com/ndomamanuel.domingos.3">facebook</a>.</strong> Todos os direitos reservados. --}}
        </footer>
    </div>
