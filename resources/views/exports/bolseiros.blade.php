<table style="border: 1px solid #000">
    <thead>
        ...
        <tr>
            ...
            <th style="background-color: #3d3d3d;color: #ffffff;padding: 20px" colspan="3">BOLSA: {{ $bolsa->nome ?? "TODOS" }}</th>
            <th style="background-color: #3d3d3d;color: #ffffff;padding: 20px" colspan="3">TOTAL DE REGISTRO: {{ count($bolseiros) }}</th>
        </tr>
...
<table>
    <thead>
        <tr>
            ...
            <th style="border: 1px solid #858585;background-color: #3d3d3d;color: #ffffff;padding: 20px" width="20">Bolsa</th>
            ...
            <th style="border: 1px solid #858585;background-color: #3d3d3d;color: #ffffff;padding: 20px" width="20">Desconto</th>
            <th style="border: 1px solid #858585;background-color: #3d3d3d;color: #ffffff;padding: 20px" width="20">Período</th>
    ...
    <tbody>
      @foreach ($bolseiros as $key => $item)
        <tr>          
            ...
            <td style="border: 1px solid #858585">{{ $item->instituicao_bolsa->desconto ?? '' }}%</td>
            <td style="border: 1px solid #858585">{{ $item->periodo->trimestre ?? '' }}</td>
