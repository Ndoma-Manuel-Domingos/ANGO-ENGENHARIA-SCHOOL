    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <form action="{{ route('est.privacidade-update', $usuario->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="password_1" class="form-label">Senha Actual</label>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="password_2" class="form-label">Nova Senha</label>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="password_3" class="form-label">Confirmar Senha</label>
