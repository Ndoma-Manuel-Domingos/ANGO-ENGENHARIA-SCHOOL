...
<body class="hold-transition sidebar-mini">
    ...
    <div class="row" style="margin-top: 170px">
       <table>
            <thead>
                <tr>
                    <td colspan="3">Funcionários:<strong> {{ $status ?? 'Todos' }}</strong></td>
                    <td colspan="2">Academico:<strong> {{ $escolaridade->nome ?? 'Todos' }}</strong></td>
                    <td colspan="2">Especialidade:<strong> {{ $especialidade->nome ?? 'Todas' }}</strong></td>
                    <td colspan="2">Universidade:<strong> {{ $universidade->nome ?? 'Todas' }}</strong></td>
                    <td colspan="2">Categoria:<strong> {{ $categoria->nome ?? 'Todas' }}</strong></td>
                </tr>
                <tr>
