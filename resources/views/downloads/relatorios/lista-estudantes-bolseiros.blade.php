    ...
    <table>
      <thead>
        ...
        <tr>
          ...
          <th style="text-align: left;text-transform: uppercase" colspan="7">{{ $bolsa ? $bolsa->nome : "TODOS" }}</th>
        </tr>
        
        <tr>
          <th colspan="3" style="text-align: left">TOTAL REGISTROS:</th>
          <th colspan="7" style="text-align: left">{{ count($bolseiros) }}</th>
        </tr>
        ...
        <tr>
            ...
            <th style="text-align: left">Bolsa</th>
      ...
      <tbody class="text-center">
        @foreach ($bolseiros as $key => $item)
            <tr>
                ...
                <td style="text-align: left">{{ $item->bolsa->nome ?? '' }}</td>
                <td style="text-align: left">{{ $item->instituicao->nome ?? '' }}</td>
                <td style="text-align: left">{{ $item->instituicao->tipo ?? '' }}</td>
                <td style="text-align: left">{{ $item->instituicao_bolsa->desconto ?? '' }}%</td>
