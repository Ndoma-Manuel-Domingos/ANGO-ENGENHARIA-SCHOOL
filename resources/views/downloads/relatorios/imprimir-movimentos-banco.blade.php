...
<main style="position: absolute;top: 230px;right: 30px;left: 30px;">
    ...
    <table>
        <tr>
            <td style="font-size: 14px;padding: 1px 0;display: block;text-align: center"><h6>RELATÓRIO DO BANCO - <strong>{{ $movimento->banco->conta ?? "" }} - {{ $movimento->banco->banco ?? "" }}</strong></h6></td>
        </tr>
    </table>
    <hr>
