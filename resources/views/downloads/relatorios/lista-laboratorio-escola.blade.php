  ...
  <div id="header">
    ...
    <div class="texto-header">
      <div>
        ...
        <h1 class="fs-5"><strong class="text-upercase">{{ $escola->nome }}</strong></h1>
        <br>
      </div>
    </div>
  </div>
    ...
    <table>
      <thead>
        <tr>
          ...
          <th colspan="" style="text-align: left">{{ count($laboratorios) }}</th>
        </tr>
        <tr>
      ...
      <tbody class="text-center">
        ...
        <tr>
          ...
          <td style="text-align: left">{{ $item->laboratorio->id }}</td>
          <td style="text-align: left">{{ $item->laboratorio->nome }}</td>
        </tr>
        @endforeach
        @endif
      </tbody>
