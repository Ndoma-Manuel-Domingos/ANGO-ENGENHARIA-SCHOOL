 ...
 @include('downloads.relatorios.header')  
  ...
  <div class="row" style="margin-top: 170px">
      <table>
          <thead>
            <tr>
              <th style="text-align: left" colspan="4">TOTAL REGISTROS:</th>
              <th style="text-align: left" colspan="2">{{ count($bancos) }}</th>
            </tr>
            <tr>
                <th style="text-align: left">Nº</th>
                <th style="text-align: left">Banco</th>
                <th style="text-align: left">Nº Conta</th>
                <th style="text-align: left">Nº IBAN</th>
