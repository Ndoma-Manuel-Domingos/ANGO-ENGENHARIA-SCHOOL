      ...
      <table>
          <thead>
            <tr>
              ...
              <th colspan="2" style="text-align: left">{{ count($classes) }}</th>
            </tr>
            <tr>
                <th style="text-align: left">Nº</th>
                <th style="text-align: left">Classe</th>
                <th style="text-align: left">Tipo</th>
                <th style="text-align: left">Nota de Avaliação</th>
              ...
              @if ($classes)
                  @foreach ($classes as $key => $item)
                      <tr>
                          ...
                          <td style="text-align: left">{{ $item->classes }}</td>
                          <td style="text-align: left">{{ $item->tipo }}</td>
                          <td style="text-align: left">{{ $item->tipo_avaliacao_nota }} Valores</td>
