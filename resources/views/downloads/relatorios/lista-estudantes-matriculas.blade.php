...
<table>
  <thead>
   <tr>
          ...
          <th colspan="6"> {{ $status ? $status : "TODOS" }}</th>
        </tr>
        <tr>
          <th colspan="2">Classes:</th>
          <th colspan="6"> {{ $classe ? $classe->classes : "TODOS" }}</th>
        </tr>
        <tr>
          <th colspan="2">Cursos:</th>
          <th colspan="6"> {{ $curso ? $curso->curso : "TODOS" }}</th>
        </tr>
        <tr>
          <th colspan="2">Turnos:</th>
          <th colspan="6"> {{ $turno ? $turno->turno : "TODOS" }}</th>
        </tr>
        <tr>
