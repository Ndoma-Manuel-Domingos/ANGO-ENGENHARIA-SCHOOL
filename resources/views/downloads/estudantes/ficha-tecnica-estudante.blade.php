...
<body>
    ...
    <div class="container">
        ...
        <table class="info-table" style="margin-top: 20px;">
            ...
            <tr>
                <td class="label">Classe Anterior:</td>
                <td>{{ $matricula->classe_at->classes ?? '-' }}</td>
            </tr>
            <tr>
        ...
        @if ($escola->categoria == 'Privado' && $pagamento)
            <!-- Contato e endereço -->
        <table class="info-table" style="margin-top: 20px;">
            <tr>
                <td colspan="2" class="label">Dados do Pagamentos</td>
            </tr>
            <tr>
                <td class="label">Factura Recibo:</td>
                <td>{{ $pagamento->next_factura }}</td>
            </tr>
            <tr>
                <td class="label">Referência da Factura:</td>
                <td>{{ $pagamento->ficha }}</td>
            </tr>
            <tr>
                <td class="label">Forma de Pagamento:</td>
                <td>{{ $pagamento->forma_pagamento->descricao }}</td>
            </tr>
            <tr>
                <td class="label">Valor Entregue:</td>
                <td>{{ number_format($pagamento->valor_entregue ?? 0 , 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td class="label">Troco:</td>
                <td>{{ number_format($pagamento->troco ?? 0 , 2, ',', '.') }}</td>
            </tr>
            <tr>
