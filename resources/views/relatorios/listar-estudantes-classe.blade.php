...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Lista dos Estudantes Classe</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-12 col-md-12">
          ...
          <div class="card p-2">
            ...
            <!-- /.row -->
            <div class="col-12 col-md-12">
              <a href="{{ route('listar-estudantes-classe', $classe->id) }}" class="btn-primary btn"><i class="fas fa-print"></i>Imprimir</a>
            </div>
