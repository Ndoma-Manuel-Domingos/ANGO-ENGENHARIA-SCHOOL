...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Facturas Convertidas</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="container-fluid">
    <section class="content">
            ...
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5 class="text-warning"><i class="fas fa-info"></i>
                        Colocar a referência da Factura, Para poder Converter a Factura
                    </h5>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="card">
                    <form action="{{ route('web.conversao-facturas-search') }}" method="POST" class="row p-4">
                        @csrf
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href='{{ route('comprovativo-factura-recibo-recibo', $item->ficha) }}' title="IMPRIMIR RECIBO" class="btn btn-secondary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        @endif

                                        @if ($item->tipo_factura == 'FT')
                                        <a href='{{ route('comprovativo-factura-factura', $item->ficha) }}' title="IMPRIMIR FACTURA" class="btn btn-secondary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        @endif

                                        @if ($item->tipo_factura == 'FR')
                                        <a href='{{ route('comprovativo-factura-recibo', $item->ficha) }}' title="IMPRIMIR FACTURA RECIBO" class="btn btn-secondary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        @endif
                                        ...
                                        <a href='{{ route('comprovativo-factura-proforma', $item->ficha) }}' title="IMPRIMIR FACTURA PRO-FORMA" class="btn btn-secondary">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        @endif
                                        {{-- printer --}}
