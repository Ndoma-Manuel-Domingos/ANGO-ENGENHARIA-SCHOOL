...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Actualizar minhas credenciais</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 mb-3">
                <form action="{{ route('prof.privacidade-update', $usuario->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="numero_avaliacoes">Número de Avaliações</label>
                                    <select name="numero_avaliacoes" class="form-control editar_numero_avaliacoes select2" id="numero_avaliacoes">
                                    ...
                                    <span class="text-danger error-text numero_avaliacoes_error"></span>
                                </div>
