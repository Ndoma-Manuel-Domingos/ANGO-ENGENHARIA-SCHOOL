...
<div class="content">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Transferência de Professores para Escolassss</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12">
                <form action="{{ route('web.transferencia-escola-professores-store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
