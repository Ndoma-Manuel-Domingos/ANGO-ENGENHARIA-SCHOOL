            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="status_classes" class="form-control status_classes select2" style="width: 100%" id="status_classes">
                    ...
                    <div class="form-group col-md-3">
                        <label for="ensino_id">Tipo Ensino</label>
                        <select name="ensino_id" class="form-control ensino_id select2" style="width: 100%" id="ensino_id">
                            <option value="">Selecionar Ensino</option>
                            @foreach ($ensinos as $item)
                            <option value="{{ $item->id }}">{{ $item->nome }}</option>
                            @endforeach
                        </select>
                        <span class="text-danger error-text ensino_id_error"></span>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="tipo_classes">Tipo Classe</label>
                        <select name="tipo_classes" class="form-control tipo_classes select2" id="tipo_classes" style="width: 100%" id="tipo_classes">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="tipo_avaliacao_nota" class="form-control tipo_avaliacao_nota select2" style="width: 100%" id="tipo_avaliacao_nota">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="ensino_id">Tipo Ensino</label>
                        <select name="ensino_id" class="form-control editar_ensino_id" id="ensino_id">
                            <option value="">Selecionar Ensino</option>
                            @foreach ($ensinos as $item)
                            <option value="{{ $item->id }}">{{ $item->nome }}</option>
                            @endforeach
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <a href="{{ route('classes-imprmir') }}" class="btn btn-danger float-end mx-1" target="_blink">Imprimir PDF</a>
                        <a href="{{ route('classes-excel') }}" class="btn btn-success float-end mx-1" target="_blink">Imprimir Excel</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="carregarTabelaClasses" style="width: 100%" class="table table-bordered  ">
                            ...
                            <tbody>
                                ...
                                @foreach ($listarClasses as $key => $item)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $item->classes }}</td>
                                    <td>{{ $item->status }}</td>
    ...
    $(function() {
        ...
        $(document).on('click', '.editar_classes_id', function(e) {
            ...
            $.ajax({
                ...
                , success: function(response) {
                    ...
                    $('.editar_ensino_id').val(response.classes.ensino_id);
        ...
        $(document).on('click', '.editar_classes_form', function(e) {
            ...
            var data = {
                ...
                , 'ensino_id': $('.editar_ensino_id').val()
            , }
