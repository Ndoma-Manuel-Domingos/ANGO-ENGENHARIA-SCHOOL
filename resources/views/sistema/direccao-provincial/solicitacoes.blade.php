                ...
                <div class="list-group">
                    <div class="list-group-item pb-4 mb-1">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <form
                                    action="{{ route('app.provincial-solicitacoes-dos-professores-resposta', $item->id) }}"
                                    method="post">
                                    @method('put')
                                    @csrf
                                    <div class="form-group col-md-12 col-12">
                                        <label for="resposta">Resposta</label>
                                        <textarea name="resposta" id="" cols="30" rows="4" class="form-control"
                                            placeholder="Descrição da Resposta">{{ old('resposta') }}</textarea>
                                        @error('resposta')
                                    ...
                                    <div class="form-group mb-3 col-md-5 col-12">
                                        <label for="resposta_opcao" class="form-label">Selecione a resposta final
                                            Sim/Não</label>
                                        <select name="resposta_opcao" id="resposta_opcao"
                                            class="form-control resposta_opcao select2">
