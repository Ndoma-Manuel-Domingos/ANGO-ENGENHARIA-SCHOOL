      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('app.listagem-estudantes-provincial', Crypt::encrypt($escola->id)) }}">Voltar a estudantes</a></li>
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                ...
                @else
                <img class="profile-user-img img-fluid img-circle" src="{{ public_path("assets/images/recursosHumanos/$estudante->image") }}" alt="User profile picture">
                @endif
              </div>
              ...
              <form action="{{ route('web.estudantes-foto-perfil') }}" method="post" class="row"
              ...
              <div class="tab-content">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $estudante->data_emissao }}" id="inputName2"
                          placeholder="Número do Bilhete" disabled>
                      </div>
                    </div>
                ...
                <div class="tab-pane" id="academico">
                  <div class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 form-control">
                          <span><a href="{{ route('web.informacao-escola-provincial', Crypt::encrypt($escola->id)) }}">{{ $escola->nome }}</a></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10 form-control">
                        <span><a href="{{ route('web.informacao-escola-provincial', Crypt::encrypt($escola->id)) }}">{{ $escola->provincia->nome ?? ""}}</a></span>
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10 form-control">
                      <span><a href="{{ route('listagem-escola-provincial', Crypt::encrypt($escola->municipio->id)) }}">{{ $escola->municipio->nome ?? "" }}</a></span>
                    </div>
                  </div>
