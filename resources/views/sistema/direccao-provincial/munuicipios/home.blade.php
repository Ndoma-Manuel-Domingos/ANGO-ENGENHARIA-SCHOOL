        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> Cadastrar, listar, editar e eliminar de Municípios. Busca avançada para melhorar na navegação do software.</h5>
                </div>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a title="Activar ou desactivar municipio" id="{{ $item->id }}" class="activar_municipio_id dropdown-item"><i class="fa fa-check"></i> Activar e Desactivar</a>
                                                @endif
                                                ...
                                                <a title="Excluir municipio" id="{{ $item->id }}" class="delete_municipio dropdown-item"><i class="fa fa-trash"></i> Excluir</a>
                                                @endif
...
<script>
    $(function() {
        ...
        $(document).on('click', '.activar_municipio_id', function(e) {
            e.preventDefault();
            var id = $(this).attr('id');
            var load = $(".ajax_load");
        ...
        // delete
        $(document).on('click', '.delete_municipio', function(e) {
            e.preventDefault();
            var id = $(this).attr('id');
            var load = $(".ajax_load");
