        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <form action="{{ route('web.controlo-lancamento-notas.store') }}" method="post">
                            <div class="card-body">
                                <div class="row">
                                    @csrf
                            ...
                            <table id="carregarCargos" style="width: 100%" class="table table-bordered  ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('web.controlo-lancamento-notas.escolas', ['lancamento_id' => $item->id]) }}">Visualizar Escolas</a></td>
