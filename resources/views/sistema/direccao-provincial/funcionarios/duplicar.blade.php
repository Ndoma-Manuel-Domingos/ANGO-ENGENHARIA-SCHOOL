...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Duplicar Registro do Funcionário</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('web.funcionarios-provincial') }}">Voltar em Funcionários</a></li>
          <li class="breadcrumb-item active">Duplicar Registro</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('web.funcionarios-provincial-duplicar-store') }}" method="post"  enctype="multipart/form-data" id="formulario_cadastro_professor">
      @csrf
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group mb-3 col-md-3 col-12">
                  <label for="instituicao_id" class="form-label">Instituições <span class="text-danger">*</span></label>
        ...
        <div class="col-md-12 col-12">
          <div class="card">
            ...
            <div class="card-footer">
              <button form="formulario_cadastro_professor" type="submit" class="btn btn-primary">Duplicar Registro</button>
            </div>
          </div>
        </div>
