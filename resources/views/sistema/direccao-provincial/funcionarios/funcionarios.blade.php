            ...
            <div class="card">
                <div class="card-header">
                  {{-- @if ($escola->categoria == 'Privado') --}}
                    ...
                    @endif
                  {{-- @endif --}}
                  <a href="{{ route('funcionarios-imprmir-municipal-pdf', ['instituicao' => 2,  'status' => $requests['status'] ?? "", 'universidade_id' => $requests['universidade_id'] ?? "", 'especialidade_id' => $requests['especialidade_id'] ?? "", 'categora_id' => $requests['categora_id'] ?? "", 'escolaridade_id' => $requests['escolaridade_id'] ?? "", 'formacao_id' => $requests['formacao_id'] ?? ""]) }}" target="_blink"
                    class="btn-danger btn float-end mx-1">Imprimir PDF</a> 
                  
                  <a href="{{ route('funcionarios-imprmir-municipal-excel', ['instituicao' => 2,  'status' => $requests['status'] ?? "", 'universidade_id' => $requests['universidade_id'] ?? "", 'especialidade_id' => $requests['especialidade_id'] ?? "", 'categora_id' => $requests['categora_id'] ?? "", 'escolaridade_id' => $requests['escolaridade_id'] ?? "", 'formacao_id' => $requests['formacao_id'] ?? ""]) }}" target="_blink"
