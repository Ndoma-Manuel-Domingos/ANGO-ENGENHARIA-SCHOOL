    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          e<li class="breadcrumb-item"><a href="{{ route('web.funcionarios-provincial') }}">Voltar em Funcionários</a></li>
...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('web.funcionarios-provincial-update', $funcionario->id) }}" method="post"
