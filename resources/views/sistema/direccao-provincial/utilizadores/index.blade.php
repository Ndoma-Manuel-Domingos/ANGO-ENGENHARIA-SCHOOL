            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header bg-light">
                      ...
                      <a href="{{ route('app.provincial-utilizadores-create') }}" class="btn btn-primary float-end">Novo Utilizador</a>
                      @endif
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    @foreach ($usuarios as $key => $usuario)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('app.provincial-utilizadores-edit', $usuario->id) }}" class="btn btn-primary">Editar</a>
                                                @endif
                                            </td>
                                        </tr>   
                                    @endforeach                          
