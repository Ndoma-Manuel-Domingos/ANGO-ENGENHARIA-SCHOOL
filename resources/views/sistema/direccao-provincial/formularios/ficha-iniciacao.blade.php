...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Ficha AFEP Pré-Escolar(Iniciação)</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12-col-md-12">
                <form action="{{ route('app.formulario.provincial.ficha-afep-iniciacao') }}" method="get">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <table id="example1" style="width: 100%"
                            ...
                            <thead>
                                <tr>
                                    <th colspan="24" class="text-center bg-info">Quadro 1. Aproveitamento dos Alunos da Iniciação.</th>
                                </tr>
                                <tr>
