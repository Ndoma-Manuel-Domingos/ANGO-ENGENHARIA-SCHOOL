...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Ficha AFEP Ensino Primário Ciclo Regular</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12-col-md-12">
                <form action="{{ route('app.formulario.provincial.ficha-afep-ensino-primario-ciclo.regular') }}" method="get">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
