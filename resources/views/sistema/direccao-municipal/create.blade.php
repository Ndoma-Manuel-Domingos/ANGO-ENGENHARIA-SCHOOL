...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1 class="m-0 text-dark">Cadastrar direcção municipal</h1>
            </div><!-- /.col -->
            <div class="col-sm-4">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 mb-3">
                <form action="{{ route('direccoes-municipais.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group mb-3 col-md-6 col-12">
                                    ...
                                    <input type="text" name="director" id="director" class="form-control director" placeholder="Nome do Director">
                                    @error('director')
                                ...
                                <div class="form-group mb-3 col-md-3 col-12">
                                    ...
                                    <input type="text" name="bilheite" id="bilheite" class="form-control bilheite" placeholder="Curso do Bilheite">
                                    @error('bilheite')
                                    <span class="text-danger error-text">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3 col-md-6 col-12">
                                    ...
                                    <input type="text" name="especialidade" id="especialidade" class="form-control especialidade" placeholder="Curso do especialidade">
                                    @error('especialidade')
                                    <span class="text-danger error-text">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3 col-md-12 col-12">
                                    ...
                                    <textarea name="descricao" id="" cols="30" rows="3" class="form-control descricao" placeholder="Descrição do director"></textarea>
                                    @error('descricao')
                                    <span class="text-danger error-text">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="" class="form-label">Nome da diracção municipal <span class="text-danger">*</span></label>
                                    <input type="text" name="nome" id="" placeholder="Escola" class="form-control">
                                    @error('nome')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="sigla" id="sigla" placeholder="Informe as Siglas EX: TEC.ONE" class="form-control" value="">
                                    @error('sigla')
                                    <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control decreto" name="decreto" placeholder="Informe o Decreto de Criação" value="">
                                    @error('decreto')
                                    <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    <label for="" class="form-label">Municipios <span class="text-danger">*</span></label>
