        ...
        <div class="row">
            <div class="col-lg-3 col-12 col-md-12">
                ...
                <div class="small-box bg-light">
                    ...
                    <a href="{{ route('app.listagem-estudantes-municipal', $escola->id) }}" class="small-box-footer">Mais Informação <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-12 col-md-12">
                ...
                <div class="small-box bg-light">
                    ...
                    <a href="{{ route('app.listagem-professores-municipal', $escola->id) }}" class="small-box-footer">Mais Informação <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td rowspan="4">
                                        ...
                                        <img src='{{ asset("assets/images/logo.png") }}' style="height: 100px; width: 100px;" class="img-circle" alt="Logotipo da instituição">
                                        @else
                                        <img src='{{ asset("assets/images/$escola->logotipo") }}' style="height: 100px; width: 100px;" class="img-circle" alt="Logotipo da instituição">
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="">Casas de Banhos: <strong>{{ $escola->casas_banho }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
