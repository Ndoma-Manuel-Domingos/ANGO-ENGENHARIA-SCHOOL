                                ...
                                <tr>
                                    <td>
                                      @if (Auth::user()->can('read: professores'))
                                        <a href="{{ route('app.informacao-professores-municipal', $item->funcionario->id) }}" class="text-secondary">{{ $item->funcionario->id }}</a>
                                      @else
                                        {{ $item->funcionario->id }}
                                      @endif
                                    </td>
                                    ...
                                    <td>
                                      @if (Auth::user()->can('read: professores'))
                                        <a href="{{ route('app.informacao-professores-municipal', $item->funcionario->id) }}" class="text-secondary">{{ $item->funcionario->nome }} {{ $item->funcionario->sobre_nome }}</a>
                                      @else
                                    ...
                                    <td>
                                      @if (Auth::user()->can('read: professores'))
                                        <a href="{{ route('app.informacao-professores-municipal', $item->funcionario->id) }}" title="Visualizar Professor" id="{{ $item->funcionario->id }}" class="btn btn-primary"><i class="fa fa-eye"></i> Visualizar </a>
                                      @endif
                                    </td>
                                </tr>    
                            @endforeach
