    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <form action="{{ route('web.municipal-activadores-candidatura-professores-post') }}" method="post">
                    @csrf
                    <div class="card">
                                ...
                                @foreach ($dados as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('web.municipal-activadores-candidatura-professores-status', $item->id) }}" class="btn btn-danger">Dasctivar</a>
                                            @endif
                                            @if ($item->status == 'desactivo')
                                            <a href="{{ route('web.municipal-activadores-candidatura-professores-status', $item->id) }}" class="btn btn-success">Activar</a>    
                                            @endif
                                        </td>
                                    </tr>   
                                @endforeach                          
