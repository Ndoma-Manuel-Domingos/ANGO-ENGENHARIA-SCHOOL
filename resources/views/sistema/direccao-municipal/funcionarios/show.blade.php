            ...
            <div class="card-body box-profile">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                ...
                @if (Auth::user()->can('update: professores'))
                  <a href="{{ route('web.funcionarios-municipal-edit', $funcionario->id) }}" title="Editar Funcionarios" class="btn btn-primary"><i class="fa fa-edit"></i> Editar</a>
                  @if ($funcionario->status == 'activo')
                      <a href="{{ route('web.funcionarios-municipal-status', $funcionario->id) }}" title="Editar Funcionarios" class="btn btn-danger"><i class="fa fa-check"></i> Desactivar</a>
                  @endif
                  @if ($funcionario->status == 'desactivo')
                      <a href="{{ route('web.funcionarios-municipal-status', $funcionario->id) }}" title="Editar Funcionarios" class="btn btn-success"><i class="fa fa-check"></i> Activar</a>
                  @endif
