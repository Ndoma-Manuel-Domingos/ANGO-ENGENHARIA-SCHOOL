  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12 col-md-12">
        <form action="{{ route('web.funcionarios-municipal') }}" method="get">
          @csrf
          <div class="card">
            <div class="card-body">
              <div class="row">
        ...
        <div class="card">
          <div class="card-header">
            <h6>Total registro : {{ count($funcionarios) }}
              ...
              <a href="{{ route('web.funcionarios-municipal-create') }}"
                class="btn btn-primary float-end mx-1">Novo Funcionário</a>
              @endif
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu">
                        ...
                        @if (Auth::user()->can('read: professores'))
                        <a href="{{ route('web.funcionarios-municipal-show', $item->id) }}" title="excluir Funcionarios" id="{{ $item->id }}" class="delete_funcionarios dropdown-item"><i class="fa fa-eye"></i> Visualizar</a>
                        @endif
                        ...
                        <a href="{{ route('web.funcionarios-municipal-destroy', $item->id) }}" title="excluir Funcionarios" id="{{ $item->id }}" class="delete_funcionarios dropdown-item"><i class="fa fa-trash"></i> Excluir</a>
                        @endif
