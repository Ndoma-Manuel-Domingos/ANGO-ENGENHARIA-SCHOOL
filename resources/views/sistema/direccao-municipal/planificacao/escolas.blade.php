        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <form action="{{ route('web.municipal-controlo-lancamento-notas.escolas') }}" method="get">
                            <div class="card-body">
                                <div class="row">
                                    @csrf
                        ...
                        <div class="card-body">
                            <table id="carregarCargos" style="width: 100%" class="table table-bordered  ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td><a href="{{ route('web.informacao-escola-municipal', $item->escola->id ) }}">{{ $item->escola->nome }}</a></td>
