        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home-municipal') }}">Voltas</a></li>
        ...
        <div class="row">
            <div class="col-lg-3 col-12 col-md-12">
                ...
                <div class="small-box bg-light">
                    ...
                    <a href="{{ route('web.municipal-controlo-lancamento-notas.index') }}" class="small-box-footer">Mais Informação <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            @if ($controlos)
            <div class="col-lg-3 col-12 col-md-12">
                ...
                <div class="small-box bg-light">
                    ...
                    <a href="{{ route('web.municipal-controlo-lancamento-notas.escolas', ['lancamento_id' => $lancamento->id]) }}" class="small-box-footer">Mais Informação <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            @endif
        </div>
