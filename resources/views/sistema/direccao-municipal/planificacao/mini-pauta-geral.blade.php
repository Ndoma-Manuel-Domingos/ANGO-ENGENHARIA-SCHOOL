        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('app.planificacao-municipal-pesquisas-mini-pauta-gerais') }}" id="formulario_pesquisar_mini_pautas_gerais" class="row" method="GET">
                                @csrf
                ...
                <div class="col-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('ficha-mini-pauta-geral', [ 'turma' => Crypt::encrypt($turma->id), 'disciplina' => Crypt::encrypt($disciplina->id), ]) }}" target="_blank" class="btn btn-primary"><i class="fas fa-print"></i> Imprimir</a>
                            @endif
                        </div>
