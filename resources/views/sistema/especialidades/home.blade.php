...
<div class="p-4 lg:p-8 space-y-8">
    <nav class="flex items-center gap-2 text-xs text-slate-500 mb-6">
        ...
        <span class="material-symbols-outlined text-[14px]">chevron_right</span>
        <span class="text-primary font-semibold">gestão de especialidades</span>
    </nav>

    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Gestão de especialidades</h1>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="relative bg-white dark:bg-sidebar-dark w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                <div class="flex items-center justify-between p-6 border-b border-slate-100 dark:border-slate-800">
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white" id="modalTitle">Criar Nova Especialidade</h3>
                ...
                <form class="p-6 space-y-5" action="{{ route('especialidades.store') }}" method="POST">
                    @csrf
                    <div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-2">
                        ...
                        @if (Auth::user()->can('create: especialidade'))
...
<script>
    ...
    function edit(id) {
        $.ajax({
            ...
            , success: function(data) {
                ...
                $("#modalTitle").text("Editar Especialidade");
                $("#botao_submiter").text("Editar Especialidade");
            ...
            , error: function(xhr) {
                ...
                let message = "Erro ao carregar dados da especialidade";
    ...
    function exportData(documentType) {
        ...
        $.ajax({
            type: "GET"
            , url: `/especialidades-export`, // rota que vai gerar o arquivo
            data: data
            , xhrFields: {
            ...
            , success: function(blob, status, xhr) {
                ...
                let filename = documentType === 'excel' ? 'especialidades.xlsx' : 'especialidades.pdf';
