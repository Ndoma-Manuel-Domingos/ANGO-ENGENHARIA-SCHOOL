      ...
      <div class="row">
        <div class="col-12 col-md-12">
            <div class="callout callout-info">
                <h5><i class="fas fa-info"></i> Listagem geral de Fornecedores.</h5>
            </div>
        </div>
      </div>
        ...
        <div class="col-12 col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('web.create-fornecedores') }}" class="btn btn-primary float-end">Nova Fornecedor</a>
                {{-- @endif --}}
                            ...
                            <td class="text-right">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                  ...
                                  <a href="{{  route('web.edit-fornecedores', $item->id ) }}" title="Editar Tipo de Mercadoria" value="{{ $item->id }}" class="dropdown-item"><i class="fa fa-edit"></i> Editar</a>
                                  {{-- @endif --}}
