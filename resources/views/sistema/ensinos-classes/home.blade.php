...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Ensinos para Classes</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home-municipal') }}">Voltar</a></li>
                    <li class="breadcrumb-item active">Ensinos Classes</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <a href="{{ route('ensinos-classes-imprmir') }}" class="btn-danger btn float-end mx-1" target="_blink"> Imprimir PDF</a>
                        <a href="{{ route('ensinos-classes-excel') }}" class="btn-success btn float-end mx-1" target="_blink"> Imprimir Excel</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
...
<script>
    $(function() {
        ...
        $(document).on('click', '.activar_provincia_id', function(e) {
            ...
            $.ajax({
                type: "GET"
                , url: "activar-provincias-classes/" + id
                , dataType: "json"
                , beforeSend: function() {
        ...
        $(document).on('click', '.cadastrar_ensinos', function(e) {
            ...
            $.ajax({
                type: "POST"
                , url: "{{ route('web.cadastrar-ensinos-classes') }}"
                , data: data
                , dataType: "json"
                , beforeSend: function() {
                    // Você pode adicionar um loader aqui, se necessário
        ...
        $(document).on('click', '.delete_ensinos', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE"
                        , url: "excluir-ensinos-classes/" + id
                        , beforeSend: function() {
                            // Você pode adicionar um loader aqui, se necessário
                            progressBeforeSend();
                        }
