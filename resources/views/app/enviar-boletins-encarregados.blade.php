...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Enviar Boletins Encarregados</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 encarregados" id="encarregados" data-placeholder="Selecione o encarregado" style="width: 100%;">
                                        @if ($encarregados)
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 estudantes" id="estudantes" data-placeholder="Selecione os estudantes deste encarregados" style="width: 100%;">
                                        @if ($estudantes)
                                    ...
                                    <span class="text-danger error-text estudantes_error"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control turma" id="turma" data-placeholder="Selecione a turma" style="width: 100%;">
                                        @if ($turmas)
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control trimestre" id="trimestre" data-placeholder="Selecione o trimestre" style="width: 100%;">
                                        @if ($trimestre)
                                    ...
                                    <span class="text-danger error-text trimestre_error"></span>
                                </div>
                            </div>

                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="anoLectivos">Ano Lectivo</label>
                                    <select class="form-control anoLectivos" id="anoLectivos" data-placeholder="Selecione o ano lectivo" style="width: 100%;">
                                        @if ($anoLectivos)
                                    ...
                                    <span class="text-danger error-text anoLectivos_error"></span>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on('click', '.enviar_boletins_submit', function(e) {
        ...
        var data = {
            ...
            , 'estudantes': $('.estudantes').val()
            , 'turma': $('.turma').val()
            , 'trimestre': $('.trimestre').val()
            , 'anoLectivos': $('.anoLectivos').val()
        ...
        $.ajax({
            type: "POST"
            , url: "{{ route('web.enviar-boletin-encarregado-post') }}"
            , data: data
            , dataType: "json"
            , beforeSend: function() {
