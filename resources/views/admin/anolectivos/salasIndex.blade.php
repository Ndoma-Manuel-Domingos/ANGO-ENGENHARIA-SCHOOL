            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <a href="{{ route('web.salas-pdf-ano-lectivo') }}" class="btn btn-danger float-end mx-1" target="_blink"> <i class="fas fa-pdf"></i> Imprimir PDF</a>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a href="{{ route('ano-lectivo.excluir-salas-ano-lectivo', $item->id) }}" title="Excluir Sala" id="{{ $item->id }}" class="dropdown-item deleteModal"><i class="fa fa-trash"></i> Excluir</a>
                                                @endif
...
<div class="modal fade" id="modalSalas">
    <div class="modal-dialog modal-xl">
        <form action="{{ route('web.cadastrar-salas-ano-lectivo') }}" id="formCreate" method="post">
...
<div class="modal fade" id="modalSalasUpdate">
    <div class="modal-dialog modal-xl">
        <form action="{{ route('web.salas-update-ano-lectivo') }}" id="formUpdate" method="post">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
    $(function() {
        ...
        excluirRegistro('.deleteModal', `{{ route('ano-lectivo.excluir-turnos-ano-lectivo', ':id') }}`);
