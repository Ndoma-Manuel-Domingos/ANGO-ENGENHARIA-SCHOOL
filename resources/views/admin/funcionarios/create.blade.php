...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('web.outro-funcionarios-store') }}" method="post" enctype="multipart/form-data" id="formulario_cadastro_professor">
      <div class="row">
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group my-5 col-md-3 col-12">
                  <label for="doc_bilheite" class="form-label">Bilhete de Identidade <span class="text-secondary">(Opcional)</span></label>
...
@section('scripts')
  <script>
    ...
    ajaxFormSubmit("#formulario_cadastro_professor");
