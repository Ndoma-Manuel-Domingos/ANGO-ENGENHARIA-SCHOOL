...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Informações Professor</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('web.funcionarios') }}">Voltar</a></li>
            <li class="breadcrumb-item active">Informação Funcionários</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> Mais informações sobre do professor <a href="">{{ $professor->nome }} {{ $professor->sobre_nome }}</a>, dados pessoais, dados académicos, turmas etc.</h5>
                </div>
            </div>
        </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                      <b>Cargo</b> <a class="float-right">{{ $contrato->cargos ? $contrato->cargos->cargo : '-----' }}</a>
                  </li>
                  
                  <li class="list-group-item">
                      <b>Departamento</b> <a class="float-right">{{ $contrato->departamento ? $contrato->departamento->departamento : '-----' }}</a>
                  </li>
                </ul>
            ...
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                @if ($escola->modulo != "Basico")
                    ...
                    @endif
                    <li class="nav-item"><a class="nav-link" href="#turmas" data-toggle="tab">Turmas</a></li>    
                @else
                    <li class="nav-item"><a class="nav-link" href="#turmas" data-toggle="tab">Turmas</a></li>  
                @endif
                  ...
                  <div class="tab-pane" id="academico">
                    <div class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" disabled value="{{ $contrato->cargos ? $contrato->cargos->cargo : "" }}" placeholder="Professor">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <input type="text" class="form-control" disabled value="{{ $contrato->departamento ? $contrato->departamento->departamento : "" }}" placeholder="Docente">
                          </div>
                      </div>
                    ...
                    @if (isset($contrato) && $contrato != null)
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="inputName2" class="col-sm-2 col-form-label">Cargo</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName2" disabled value="{{ $contrato->cargos ? $contrato->cargos->cargo : "" }}" placeholder="Professor">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputName2" class="col-sm-2 col-form-label">Departamento</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName2" disabled value="{{ $contrato->departamento ? $contrato->departamento->departamento : "" }}" placeholder="Docente">
                                </div>
                            </div>
                  ...
                  @if ($turmas)
                      @foreach ($turmas as $item)
                          <div class="col-12 py-0 px-0">
                              <h1 class="bg-dark p-1 fs-5 mt-3">Turma: {{ $item->turma->turma }} </h1>
                              @php
                                $horario = App\Models\web\turmas\Horario::where('professor_id', $item->professor->id)
                              ...
                              @if ($horario)
                                <div class="table-responsive">
                                  <table  style="width: 100%" class="table table-bordered table-striped" style="width: 100%">
                                      <thead>
                                          <tr>
                                              <th>Disciplina</th>
                                              <th>Dias Semanas</th>
                                      ...
                                      <tbody>
                                          ...
                                          @endforeach
                                          <tr>
                                              <td colspan="5" class="bg-secondary"> Total de Tempos Semanal nesta Turma: {{ $totalTempo }}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                                </div>
                              ...
                              @php $total_tempos += $totalTempo; @endphp
                          </div>   
                      @endforeach
                  @endif
                  
                  <div class="col-12 col-md-12 mt-4">
                    <h1 class="fs-5">TOTAL DE TEMPOS DO PROFESSOR: {{ $total_tempos }}</h1>
                  </div>
                </div>    
        ...
        <div class="card">
            <div class="py-3 px-3">
                @if ($escola->modulo != "Basico")
                    ...
                    @endif
                    <a href="{{ route('ficha-funcionario-turma', Crypt::encrypt($professor->id)) }}" class="btn btn-primary" target="_blank"><i class="fas fa-print"></i> Turmas</a>
                @else
                    <a href="{{ route('ficha-funcionario-turma', Crypt::encrypt($professor->id)) }}" class="btn btn-primary" target="_blank"><i class="fas fa-print"></i> Turmas</a>
                @endif
            </div>
