...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('web.outro-funcionarios-update', $funcionario->id) }}" method="post" enctype="multipart/form-data" id="formulario_cadastro_professor">
        @csrf
        @method('put')
          <div class="row">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="pai" class="form-label">Nome Completo do Pai <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="mae" class="form-label">Nome Completo da Mãe <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="emissiao_bilheite" class="form-label">Data Emissão Bilhete <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3 col-md-3 col-12">
                      <label for="endereco" class="form-label">Endereço da Morada <span class="text-secondary">(Opcional)</span></label>
                      <textarea name="endereco" id="endereco" class="form-control endereco" placeholder="descrever endereço" id="endereco" rows="1">{{ old('endereco') ??  $funcionario->endereco  }}</textarea>
                      @error('endereco')
                      <span class="text-danger error-text">{{ $message }}</span>
                      @enderror
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="ano_trabalho" class="form-label">Tempo de Trabalho <span class="text-secondary">(Opcional)</span></label>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="telefone" class="form-label">Telefone <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="facebook" class="form-label">Facebook <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group mb-3 col-md-3 col-12">
                      <label for="instagram" class="form-label">Instagram <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group mb-3 col-md-6 col-12">
                      <label for="whatsapp" class="form-label">Whatsapp <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group mb-3 col-md-6 col-12">
                      <label for="outras_redes" class="form-label">Outras Redes <span class="text-secondary">(Opcional)</span></label>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group my-5 col-md-3 col-12">
                      <label for="doc_bilheite" class="form-label">Bilhete de Identidade ou Passporte <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group my-5 col-md-3 col-12">
                      <label for="doc_certificado" class="form-label">CV <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group my-5 col-md-3 col-12">
                      <label for="doc_atestedao_medico" class="form-label">Atestado Médico <span class="text-secondary">(Opcional)</span></label>
                    ...
                    <div class="form-group my-5 col-md-3 col-12">
                      <label for="doc_outros" class="form-label">Outros Documentos <span class="text-secondary">(Opcional)</span></label>
