        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> Cadastrar, listar, editar e eliminar de Banco. Busca avançada para melhorar na navegação do software.</h5>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table id="carregarTabela" style="width: 100%" class="table table-bordered  ">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a title="Fechamento do Caixa" href="{{ route('web.fechamento-banco') }}" class="dropdown-item"><i class="fa fa-edit"></i> Fechar caixa</a>
                                                {{-- @endif --}}

                                                {{-- @if (Auth::user()->can('retirar valores caixa')) --}}
                                                <a title="Fechamento do Caixa" href="{{ route('web.retirar-valores-banco', Crypt::encrypt($movimento->id)) }}" class="dropdown-item"><i class="fa fa-edit"></i> Retirar Valor</a>
                                                {{-- @endif --}}
                            ...
                            <tfoot>
                                <th colspan="5" class="text-danger">Total Retirado <strong>{{ number_format(($movimento->valor_retirado1 + $movimento->valor_retirado2 + $movimento->valor_retirado3)  , '2', ',', '.') }} Kz</strong></th>
                                <th colspan="5" class="text-success">Saldo Final <strong>{{ number_format( (($movimento->valor_cache + $movimento->valor_abrir + $movimento->valor_tpa) - ($movimento->valor_retirado1 + $movimento->valor_retirado2 + $movimento->valor_retirado3))  , '2', ',', '.') }} Kz</strong></th>
                            </tfoot>
                            @endif
                            </tbody>
                        </table>
