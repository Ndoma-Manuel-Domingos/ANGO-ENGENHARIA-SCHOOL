        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> Cadastrar, listar, editar e eliminar de Turnos. Busca avançada para melhorar na navegação do software.</h5>
                </div>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                @if (Auth::user()->can('update: estado') && Auth::user()->can('update: turno'))
