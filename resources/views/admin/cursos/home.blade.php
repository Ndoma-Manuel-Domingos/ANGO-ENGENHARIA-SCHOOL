        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> Cadastro, listar, editar e eliminar de Cursos. Cadastro de
                        disciplinas para respectivo curso. Busca avançada para melhorar na navegação do software.</h5>
                </div>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a href="{{ route('disciplinas-curso-imprmir', $item->id) }}" target="_blink" title="Imprimir lista das disciplinas" class="dropdown-item"><i class="fa fa-print"></i>
                                                ...
                                                @if (Auth::user()->can('update: curso') && Auth::user()->can('update: estado'))
        ...
        $(document).on('click', '.editar_cursos_id', function(e) {
            ...
            $.ajax({
                ...
                , success: function(response) {
                    ...
                    $('.editar_area_formacao_cursos').val(response.cursos
                        .area_formacao);
