    ...
    <div class="a6">
        ...
        <table class="table-taxas">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 2px;text-align: left">Isento nos termos da alínea d) do nº1 do artigo 12.º do CIVA </td>
                </tr>
                @endif
        ...
        <div style="margin-top: 20px;">
            ...
            <table width="95%" style="margin-top: 20px;border-top: 2px solid #c4c4c4;border-bottom: 2px solid #c4c4c4">
                ...
                <tr>
                    <td width="50%"> Multa: <strong>{{ number_format(($pagamento->multa ?? 0) , '2', ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td width="50%"> Total: <strong>{{ number_format(($pagamento->total_incidencia + $pagamento->total_iva + $pagamento->multa ?? 0) , '2', ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td width="50%"> Total Pago: <strong>{{ number_format(($pagamento->total_incidencia + $pagamento->total_iva + $pagamento->multa ?? 0) - $total_retencao , '2', ',', '.') }}</strong></td>
                </tr>
            </table>
        </div>
