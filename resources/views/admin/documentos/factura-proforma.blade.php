...
<body>
    ...
    <div class="container" style="width: 21cm; height: auto;">
        ...
        <div style="margin-top: 10px">
            <p style="color: #9a1e1a;font-size: 20px">Este documento não serve como fatura</p>
        </div>
        ...
        <div style="margin-top: 20px;">
            ...
            <table width="95%" style="margin-top: 20px;border-top: 2px solid #c4c4c4;border-bottom: 2px solid #c4c4c4">
                ...
                <tr>
                    <td width="50%"></td>
                    <td width="50%"> Total a pagar: <strong>{{ number_format($pagamento->total_incidencia + $pagamento->total_iva , '2', ',', '.') }}</strong></td>
                </tr>
            </table>
        </div>
