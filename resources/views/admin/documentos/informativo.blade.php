...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Documentos Informativos</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> controle geral das facturas informativas (Facturas Pro-forma).</h5>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('web.documento.informativo') }}" method="GET" class="row" id="formulario">
                            @csrf
