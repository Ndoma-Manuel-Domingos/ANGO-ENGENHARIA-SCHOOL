...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Documentos Facturação</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="callout callout-info">
                    <h5><i class="fas fa-info"></i> controle geral todas facturas de facturação (Facturas Recibos e Facturas).</h5>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('web.documento.facturacao') }}" method="GET" class="row" id="formulario">
                            @csrf
        ...
        <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href='{{ route('web.recuperar-facturas-create', $item->ficha) }}' target="_blink" title="Recuperada Factura" class="btn btn-warning mx-2">
                                            <i class="fas fa-undo-alt"></i>
                                        </a>
                                        @else
                                        <a href='{{ route('web.cancelar-facturas-create', $item->ficha) }}' target="_blink" title="Anular Factura" class="btn-danger mx-2">
            ...
            <div class="col-12 mb-5">
                <a href="{{ route('ficha-pagamentos-receber', ['data_inicio' => $filtros['data_inicio'] ?? '', 'data_final' => $filtros['data_final'] ?? '']) }}" class="btn btn-primary" target="_blink">Imprimir <i class="fas fa-print"></i></a>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
