...
<div class="p-4 lg:p-8 space-y-8">
    <nav class="flex items-center gap-2 text-xs text-slate-500 mb-6">
        ...
        <span class="material-symbols-outlined text-[14px]">chevron_right</span>
        <span class="text-primary font-semibold">gestão de escolaridades</span>
    </nav>
    
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Gestão de escolaridades</h1>
        ...
        <div>
            <button id="openModal"
                ...
                <span>Criar Nova Escolaridade</span>
            </button>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between p-6 border-b border-slate-100 dark:border-slate-800">
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white" id="modalTitle">Criar Nova Escolaridade</h3>
                ...
                <form class="p-6 space-y-5" action="{{ route('escolaridades.store') }}" method="POST">
                    @csrf
                    <div>
...
@section('scripts')
  <script>
      ...
      $(document).on('click', '.delete-record', function(e) {
          ...
          , }).then((result) => {
              if (result.isConfirmed) {
                  ...
                  $.ajax({
                      url: `{{ route('escolaridades.destroy', ':id') }}`.replace(':id', recordId), 
                      method: 'DELETE', 
                      data: {
      ...
      function edit(id) {
          $.ajax({
              ...
              success: function (data) {
                  ...
                  $("#modalTitle").text("Editar Escolaridade");
                  $("#botao_submiter").text("Editar Escolaridade");
              ...
              error: function (xhr) {
                  ...
                  let message = "Erro ao carregar dados da escolaridade";
      ...
      function exportData(documentType) {
          ...
          $.ajax({
              type: "GET",
              url: `/escolaridades-export`, // rota que vai gerar o arquivo
              data: data,
              xhrFields: {
              ...
              success: function(blob, status, xhr) {
                  ...
                  let filename = documentType === 'excel' ? 'escolaridades.xlsx' : 'escolaridades.pdf';
