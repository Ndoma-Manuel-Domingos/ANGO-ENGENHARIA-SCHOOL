...
<div class="p-4 lg:p-8 space-y-8">
    <nav class="flex items-center gap-2 text-xs text-slate-500 mb-6">
        ...
        <span class="material-symbols-outlined text-[14px]">chevron_right</span>
        <span class="text-primary font-semibold">gestão de formação académicas</span>
    </nav>
    
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Gestão de formação académicas</h1>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between p-6 border-b border-slate-100 dark:border-slate-800">
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white" id="modalTitle">Criar Nova Formação</h3>
                ...
                <form class="p-6 space-y-5" action="{{ route('formacao-academico.store') }}" method="POST">
                    @csrf
                    <div>
...
@section('scripts')
  <script>
      ...
      $(document).on('click', '.delete-record', function(e) {
          ...
          , }).then((result) => {
              if (result.isConfirmed) {
                  ...
                  $.ajax({
                      url: `{{ route('formacao-academico.destroy', ':id') }}`.replace(':id', recordId), 
                      method: 'DELETE', 
                      data: {
      ...
      function edit(id) {
          $.ajax({
              url: `/formacao-academico/${id}/edit`,
              type: "GET",
              dataType: "json",
              beforeSend: function () {
              ...
              success: function (data) {
                  ...
                  $("#modalTitle").text("Editar Formação");
                  $("#botao_submiter").text("Editar Formação");
              ...
              error: function (xhr) {
                  ...
                  let message = "Erro ao carregar dados da Formação";
      ...
      function exportData(documentType) {
          ...
          $.ajax({
              type: "GET",
              url: `/formacao-academico-export`, // rota que vai gerar o arquivo
              data: data,
              xhrFields: {
              ...
              success: function(blob, status, xhr) {
                  ...
                  let filename = documentType === 'excel' ? 'formacao-academico.xlsx' : 'formacao-academico.pdf';
