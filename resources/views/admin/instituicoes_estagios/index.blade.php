        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    ...
                    <a href="{{ route('instituicoes_estagios.cadastrar-instituicao-estagios') }}" class="float-end btn-primary btn">Nova Instituição</a>
                    @endif
                    </div>
                    <!-- /.card-header -->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a href="{{ route('instituicoes_estagios.editar-instituicao-estagio', Crypt::encrypt($item->id)) }}" title="Editar Instituição" class="dropdown-item"><i class="fa fa-edit"></i> Editar</a>
                                                    @endif
                                                    @if (Auth::user()->can('read: instituicao')) 
                                                    <a href="{{ route('instituicoes_estagios.show-instituicao-estagio', Crypt::encrypt($item->id)) }}" title="Visualizar Instituição" class="dropdown-item"><i class="fa fa-edit"></i> Visualizar</a>
                                                    @endif
                                                    @if (Auth::user()->can('delete: instituicao')) 
                                                    <a href="{{ route('instituicoes_estagios.delete-instituicao-estagio', Crypt::encrypt($item->id)) }}" title="Eliminar Instituição" class="dropdown-item text-danger"><i class="fa fa-trash"></i> Eliminar</a>
                                                    @endif
