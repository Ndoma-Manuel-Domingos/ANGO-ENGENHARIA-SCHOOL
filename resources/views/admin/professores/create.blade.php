...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Cadastro de Professores</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
    ...
    <form action="{{ route('shcools.professores-store') }}" method="post" enctype="multipart/form-data" id="formulario_cadastro_professor">
             ...
             <div class="row">
                ...
                <div class="form-group mb-3 col-md-3 col-12">
                  ...
                  <select name="categoria_id" id="categoria_id" class="form-control categoria_id select2">
                    ...
                    <option value="{{ $item->id }}" {{ $item->nome == 'Nenhum categoria' ? 'selected' : '' }}>{{ $item->nome }}</option>
                    @endforeach
                  </select>
                  @error('categoria_id')
                  <span class="text-danger error-text">{{ $message }}</span>
                ...
                <div class="form-group mb-3 col-md-3 col-12">
                  ...
                  <select name="universidade_id" id="universidade_id" class="form-control universidade_id select2">
                    ...
                    <option value="{{ $item->id }}" {{ $item->nome == 'Nenhuma Universidade' ? 'selected' : '' }}>{{ $item->nome }}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group mb-3 col-md-3 col-12">
                  ...
                  <select name="especialidade_id" id="especialidade_id" class="form-control especialidade_id select2">
                    ...
                    <option value="{{ $item->id }}" {{ $item->nome == 'Nenhuma Especialidade' ? 'selected' : '' }}>{{ $item->nome }}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group mb-3 col-md-3 col-12">
                  ...
                  <select name="escolaridade_id" id="escolaridade" class="form-control escolaridade_id select2">
                    ...
                    <option value="{{ $item->id }}" {{ $item->nome == 'Nenhum Nível' ? 'selected' : '' }}>{{ $item->nome }}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group mb-3 col-md-6 col-12">
                  ...
                  <select name="formacao_academica_id" id="formacao_academica_id" class="form-control formacao_academica_id  select2">
                    ...
                    <option value="{{ $item->id }}" {{ $item->nome == 'Nenhuma Formação' ? 'selected' : '' }}>{{ $item->nome }}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group mb-3 col-md-6 col-12">
                  ...
                  <input type="text" name="ano_trabalho" value="1" class="form-control" placeholder="Tempo de Trabalho na Educação">
                  @error('ano_trabalho')
                  <span class="text-danger error-text">{{ $message }}</span>
                  @enderror
                </div> 
        ...
        <div class="col-md-12 col-12">
          <div class="card">
            ...
            <div class="card-footer">
              <button form="formulario_cadastro_professor" type="submit" class="btn btn-primary">Salvar</button>
            </div>
        </div>
      </div>
