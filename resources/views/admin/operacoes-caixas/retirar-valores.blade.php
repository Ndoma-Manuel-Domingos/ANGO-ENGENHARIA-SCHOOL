...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Retira Valores do Caixas</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12 col-md-12">
            <div class="callout callout-info">
                <h5><i class="fas fa-info"></i> Sagriamento do Caixa para poder facturar.</h5>
            </div>
        </div>
    </div>
      ...
      <div class="row">
        <div class="col-12 col-md-12">
          <div class="card">
            <!-- form start -->
            <form action="{{ route('operacoes-caixas.retirar-valores-caixa-post') }}" method="post">
              @csrf
              <div class="card-body">

                <div class="form-group">
                  <label>Selecionar o Caixa</label>
                  <select class="form-control caixa_id @error('caixa_id') is-invalid @enderror" style="width: 100%;" name="caixa_id">
