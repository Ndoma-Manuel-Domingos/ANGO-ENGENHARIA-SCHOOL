        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    ...
                    <a href="{{ route('permissions-escola.create') }}" class="btn btn-primary float-end">Nova Permissão</a>
                    @endif
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    @foreach ($permissions as $key => $item)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{ route('permissions-escola.edit', Crypt::encrypt($item->id)) }}" class="btn btn-primary">Editar</a>
                                                @endif
                                                {{-- @if (Auth::user()->can('delete: permission'))
                                                <a href="{{ route('app.permissions-escola.delete', $item->id) }}" class="btn btn-danger">Apagar</a>
                                                @endif --}}
                                            </td>
                                        </tr>   
                                    @endforeach                          
