...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <form action="{{ route('web.escolas-afilhares.create-estudantes-store', Crypt::encrypt($escolas->id)) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 col-12">
                                    ...
                                    <input type="number" name="media" value="{{ old('media') }}" max="20" min="0" maxlength="20" minlength="0" class="form-control bilheite" placeholder="Introduz a média do estudante">
                                    @error('media')
