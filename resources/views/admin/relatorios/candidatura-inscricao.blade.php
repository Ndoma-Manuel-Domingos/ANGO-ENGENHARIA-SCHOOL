...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Relatórios Candidaturas</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <form method="get" action="{{ route('web.relatorios-candidatura-inscricao') }}">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                      <a href="{{ route('web.relatorios-candidatura-inscricao-excel', ['cursos_id' => $requests['cursos_id'] ?? "", 'classes_id' => $requests['classes_id'] ?? "", 'turnos_id' => $requests['turnos_id'] ?? "", 'status' => $requests['status'] ?? ""]) }}" target="_blink" class="btn btn-success float-end"><i class="fas fa-file-excel"></i> Imprimir Excel</a>
                      <a href="{{ route('estudantes-inscricoes-imprmir', ['cursos_id' => $requests['cursos_id'] ?? "",'classes_id' => $requests['classes_id'] ?? "",'turnos_id' => $requests['turnos_id'] ?? "",'status' => $requests['status'] ?? ""]) }}" class="btn btn-danger float-end mx-2" target="_blink"><i class="fas fa-file-pdf"></i> Imprimir</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
