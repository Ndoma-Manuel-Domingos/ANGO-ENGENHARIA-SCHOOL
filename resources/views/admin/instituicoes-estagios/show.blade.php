            ...
            <div class="col-12 col-md-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            <a href="{{ route('instituicoes.associar-bolsas', Crypt::encrypt($institicao->id)) }}" class="btn btn-primary btn float-end">Associar Tipo de Estagio a esta instituição</a>
                        </div>
