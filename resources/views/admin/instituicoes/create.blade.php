...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Cadastrar Instituições Educacionais</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 mb-3">
                <form action="{{ route('instituicoes.cadastrar-instituicao-store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
