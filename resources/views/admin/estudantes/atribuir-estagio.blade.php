    ...
    <div class="container-fluid">
      ...
      <div class="row"> 
        <div class="col-12 col-md-12 mb-3">
            <form action="{{ route('web.estudante-atribuir-estagio-store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
