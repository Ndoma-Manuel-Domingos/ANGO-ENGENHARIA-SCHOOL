...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Matriculas</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="card">
                    <form action="{{ route('web.estudantes-matricula') }}" method="get">
                        @csrf
                        <div class="card-body">
                            <div class="row">
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('web.estudantes-matricula-create') }}" class="btn btn-primary float-end">Novas Matrículas</a>
                        @endif
                        <a href="{{ route('estudantes-matriculas-imprmir', ['status' => $filtros['status'], 'cursos_id'=>$filtros['cursos_id'], 'classes_id' => $filtros['classes_id'], 'turnos_id' => $filtros['turnos_id'] ]) }}" class="btn-danger btn float-end mx-2" target="_blink"><i class="fas fa-file-pdf"></i> Imprimir</a>
                        <a href="{{ route('estudantes-matriculas-imprmir-excel', ['status' => $filtros['status'], 'cursos_id'=>$filtros['cursos_id'], 'classes_id' => $filtros['classes_id'], 'turnos_id' => $filtros['turnos_id'] ]) }}" class="btn-success btn float-end mx-2" target="_blink"><i class="fas fa-file-excel"></i> Imprimir</a>
                    </div>
                    <!-- /.card-header -->
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                {{-- <a title="Imprimir 2º via da Ficha de matricula" href="{{ route('ficha-matricula2', Crypt::encrypt($item->ficha)) }}" target="_blink" id="{{ $item->id }}" class="dropdown-item"><i class="fa fa-print"></i> Imprimir 2º Via ficha Matricula</a> --}}
                                                @endif
                                                @endif
