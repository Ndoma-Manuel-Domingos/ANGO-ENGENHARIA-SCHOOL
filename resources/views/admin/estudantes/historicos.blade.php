...
<div class="content">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Históricos do Estudante</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="callout callout-info">
                        <h5><i class="fas fa-info"></i> Mais informações sobre do historico do estudante, classe, curso, turno, turmas,
            ...
            <div class="row">
                        ...
                        <div class="card-header p-2">
                            <div class="float-left">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#dados_pessoas" data-toggle="tab">Transferências</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#dados_pessoas_pai" data-toggle="tab">Notas</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#dados_pessoas_mae" data-toggle="tab">Matriculas/Confirmações</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="dados_pessoas">
                                    @if (count($transferencias) > 0)
                                        ...
                                        <div class="card">
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 col-12">
                                                            <input type="email" class="form-control" value="{{ $item->id }} " id="inputName" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 col-12">
                                                            <input type="text" class="form-control" value="{{ $item->origem->nome }}" id="inputName2" placeholder="Número do Bilhete/Cédula do Estudante" disabled>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-header">
                                                <a href="{{ route('web.transferencia-escolares-imprimir', $item->id) }}" target="_blink" class="float-right btn btn-primary">Imprimir Transferência</a>
                                                <a href="{{ route('web.transferencia-escolares-visualizar', $item->id) }}" target="_blink" class="float-right btn btn-primary mx-2"> Mais informações da Transferência</a>
                                            </div>
                                        </div>
                                        @endforeach
                                    @endif
                                ...
                                <div class="tab-pane" id="academico">
                                    ...
                                    @if ($item->pagamento == "mensal")
                                        @php
                                        $servicos =(new App\Models\web\estudantes\CartaoEstudante())::where('servicos_id', $item->servicos_id)
                                                ...
                                                <tr class="bg-light">
                                                    ...
                                                    <td>
                                                        @if ($item2->status == "Nao Pago")
                                                           <span class="badge bg-danger">{{ $item2->status }}</span> 
                                                        @endif
                                                        @if ($item2->status == "Pago")
                                                           <span class="badge bg-success">{{ $item2->status }}</span> 
                                                        @endif
                                                        @if ($item2->status == "divida")
                                                           <span class="badge bg-warning">{{ $item2->status }}</span> 
                                                        @endif
                                                        @if ($item2->status == "Isento")
                                                           <span class="badge bg-secondary">{{ $item2->status }}</span> 
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
                ...
                <div class="col-md-3 col-12">
                    <form action="{{ route('web.historicos-estudante', Crypt::encrypt($estudante->id)) }}" method="get">
