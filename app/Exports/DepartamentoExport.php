...
class DepartamentoExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithStyles, WithTitle

{
    ...
    */
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('DEPARTAMENTOS');
    ...
    {
        return "LISTAGEM DOS DEPARTAMENTOS";
    }
