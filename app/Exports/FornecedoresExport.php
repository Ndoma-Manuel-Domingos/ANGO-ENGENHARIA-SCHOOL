...
class FornecedoresExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithStyles, WithTitle

{
    ...
    */
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('FORNECEDORES');
