...
class CargosExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithStyles, WithTitle

{
    ...
    */
    ...
    {
        return Cargo::with('departamento')->where([
