...
class TipoMercadoriaExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithStyles, WithTitle

{
    ...
    */
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('TIPOS DE MERCADORIAS');
    ...
    {
        return "LISTAGEM DOS TIPOS DE MERCADORIAS";
    }
