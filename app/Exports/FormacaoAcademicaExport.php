...
class FormacaoAcademicaExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithStyles, WithTitle

{
    ...
    */
    ...
    {
        return FormacaoAcedemico::where([
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('FORMAÇÂO ACADÉMICAS');
    ...
    {
        return "LISTAGEM DAS FORMAÇÂO ACADEMICAS";
    }
