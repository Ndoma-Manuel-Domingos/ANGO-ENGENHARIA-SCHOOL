...
class FaculdadeExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithDrawings, WithCustomStartCell, WithStyles, WithTitle
{
    ...
    */
    ...
    public function drawings()
    {
        ...
        $drawing->setDescription('FACULDADES');
    ...
    {
        return "LISTAGEM DAS FACULDADES";
    }
