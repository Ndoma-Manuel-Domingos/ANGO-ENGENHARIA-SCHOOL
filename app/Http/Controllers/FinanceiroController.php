...
class FinanceiroController extends Controller
{
    ...
    public function limparPagamento($id)
    {
        // Aumenta o tempo de execução
        ini_set('max_execution_time', 0); // 0 = infinito
        set_time_limit(0);
        ...
        try {
            ...
            $pagamento = Pagamento::with(['servico'])->findOrFail(Crypt::decrypt($id));
        ...
        Alert::success("Bom Trabalho", "Pagamento limpado com sucesso!");
        return redirect()->back();
    }
