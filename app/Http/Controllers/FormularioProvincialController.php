...
class FormularioProvincialController extends Controller
{
    //
        
    public function provincialFormularioFicha(Request $request)    
    {
        $user = auth()->user();
        ...
        $headers =  [
            "titulo" => "Formulários e ficha",
            "descricao" => env('APP_NAME'),
            "direccao" => $direccao,
            "usuario" => User::findOrFail(Auth::user()->id),
        ];
        
        return view('sistema.direccao-provincial.formularios.index', $headers);
    }
    ...
    public function iniciacao(Request $request)
    {
        ...
        $ids_turmas_da_iniciacao = Turma::whereIn('classes_id', $classes_ids)->pluck('id');
        ...
        return view('sistema.direccao-provincial.formularios.iniciacao', $headers);
    }
    ...
    public function fichaAFEPIniciacao(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.ficha-iniciacao', $headers);
    }
    ...
    public function primarioRegular(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.primario-regular', $headers);
    }
    ...
    public function fichaAFEPEnsinoPrimarioRegular(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.ficha-ensino-primario-regular', $headers);
    }
    ...
    public function primarioCicloRegular(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.primario-ciclo-regular', $headers);
    }
    ...
    public function fichaAFEPEnsinoPrimarioCicloRegular(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.ficha-ensino-primario-ciclo-regular', $headers);
    }
    ...
    public function segundoCicloRegular(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.segundo-ciclo-regular', $headers);
    }
    ...
    public function fichaAFEPEnsinoSegundoCicloRegular(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.formularios.ficha-ensino-segundo-ciclo-regular', $headers);
    }
