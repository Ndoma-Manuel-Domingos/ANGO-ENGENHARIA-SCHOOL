...
class PrinterController extends Controller
{
    ...
    public function estudantesDevedoresImprimir(Request $request)
    {
        ini_set('memory_limit', '4096M');  // Ajuste para 1024 MB ou outro valor
        ...
        $cartoes = CartaoEstudante::with(['estudante.matricula', 'servico'])->when($request->servico, function ($query, $value) {
