...
class TipoMaterialController extends Controller
{
    ...
    public function index()
    {
        ...
        $headers = [
            ...
            "tipos" => TipoMeterial::where('shcools_id', $this->escolarLogada())->get(),
        ];
        
        return view('admin.bibliotecas.tipos-materiais.index', $headers);
    }
    ...
    public function edit($id)
    {
        ...
        $registro = TipoMeterial::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validate->fails()) {
            ...
            $update = TipoMeterial::findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        $delete = TipoMeterial::findOrFail($id);
        $delete->delete();
