...
class EnsinoClasseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $headers = [
            ...
            "datas" => EnsinoClasse::get(), 
            "usuario" => User::findOrFail(Auth::user()->id),
            "loyout" => $request->loyout,
        ];

        return view('sistema.ensinos-classes.home', $headers);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validate->fails()) {
            ...
            $update = EnsinoClasse::findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        $data = EnsinoClasse::findOrFail($id);
        $data->delete();
    ...
    public function ensinosImprimir()
    {
        ...
        return $pdf->stream('lista-ensinos-classes.pdf');
    }

    public function ensinosExcel()
    {
        return Excel::download(new EnsinoExport, 'ensinos-classes.xlsx');
    }
}
