...
class CargoMunicipalController extends Controller
{
    use TraitHelpers;
    ...
    public function index()
    {
        ...
        return view('sistema.direccao-municipal.cargos.home', $headers);
    }
    ...
    public function create()
    {
        ...
        return view('sistema.direccao-municipal.cargos.create', $headers);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('web.cargos-municipal');
    }
    ...
    public function edit($id)
    {
        ...
        return view('sistema.direccao-municipal.cargos.edit', $headers);
    }
    ...
    public function Imprimir()
    {
        ...
        return $pdf->stream('lista-cargos-municipal.pdf');

    }  
    
    public function excel()
    {
        return Excel::download(new CargosExport, 'cargos-municipal.xlsx');
    }
