...
class ControloLancamentoNotasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sistema.direccao-provincial.planificacao.criar-controlo', $headers);
    }
    ...
    public function store(Request $request)
    {
        ...
        $lancamento = ControloLancamentoNotas::where('status', 'activo')->where('level', '2')->where('ano_lectivo_global_id', $this->anolectivoActivoGlobal())->where('direccao_id', $user->shcools_id)->first();
    ...
    public function escolas(Request $request)
    {
        ...
        return view('sistema.direccao-provincial.planificacao.escolas', $headers);
    }
    ...
    public function controlo()
    {
        ...
        return view('sistema.direccao-provincial.planificacao.controlo', $headers);
    }
    ...
    public function miniPauta()
    {
        ...
        return view('sistema.direccao-provincial.planificacao.mini-pauta', $headers);
    }
    ...
    public function pesquisarMiniPauta(Request $request)
    {
        ...
        $request->validate([
            ...
            "condicao_pesquisar.required" => "Campo Obrigatório",
            "trimestre_id.required" => "Campo Obrigatório",
        ]);
        ...
        $headers = [
            "titulo" => "Pesquisa de mini pautas",
            "descricao" => env('APP_NAME'),
            "pesquisa_turma" => $turma,
    ...
    public function miniPautaGeral()
    {
        ...
        return view('sistema.direccao-provincial.planificacao.mini-pauta-geral', $headers);
    }
    ...
    public function mapaAproveitamentoGeral()
    {
        ...
        return view('sistema.direccao-provincial.planificacao.mapa-aproveitamento', $headers);
    }
