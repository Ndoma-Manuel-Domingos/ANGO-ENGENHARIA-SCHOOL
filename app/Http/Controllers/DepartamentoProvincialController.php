...
class DepartamentoProvincialController extends Controller
{
    //    
    ...
    public function index()
    {
        ...
        return view('sistema.direccao-provincial.departamentos.home', $headers);
    }
    ...
    public function create()
    {
        ...
        return view('sistema.direccao-provincial.departamentos.create', $headers);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('web.departamento-provincial');
    }
    ...
    public function edit($id)
    {
        ...
        return view('sistema.direccao-provincial.departamentos.edit', $headers);
    }
