...
class DistritoPortalProvinciaController extends Controller
{
         /**
    ...
    public function index()
    {
        ...
        $municipios_ids = Municipio::where('provincia_id', $direccao->provincia_id)->pluck('id');
    
        $headers = [
            "titulo" => "Lista de Distritos",
            "descricao" => env('APP_NAME'),
            "municipios" => $municipios, 
            "datas" => Distrito::whereIn('municipio_id', $municipios_ids)->with('municipio')->get(), 
            "usuario" => User::findOrFail(Auth::user()->id),
        ];

        return view('sistema.direccao-provincial.distritos.home', $headers);
    }
