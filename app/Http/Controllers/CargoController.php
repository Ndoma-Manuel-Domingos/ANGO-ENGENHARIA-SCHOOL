...
class CargoController extends Controller
{
    ...
    public function index()
    {
        ...
        $cargos = Cargo::where('shcools_id', $this->escolarLogada())->where('level', '4')->with('departamento')->get();
        ...
        return view('admin.cargos.home', $headers);
    }
    ...
    public function create()
    {
        ...
        return view('admin.cargos.create', $headers);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('web.cargos');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.cargos.edit', $headers);
    }
    ...
    public function Imprimir()
    {
        ...
        $headers = [
            ...
            "cargos" => Cargo::where('level', '4')->with('departamento')->where([
                ['shcools_id', '=', $this->escolarLogada()]
            ])->get()
        ];

        $pdf = \PDF::loadView('downloads.relatorios.lista-cargos', $headers);
        return $pdf->stream('lista-cargos.pdf');
    }
