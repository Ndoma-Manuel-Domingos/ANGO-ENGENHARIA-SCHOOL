...
class CreateTbPagamentosNotasCreditosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_pagamentos_notas_creditos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_pagamentos_notas_creditos');
    }
}
