...
class CreateTbPagamentosRecibosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_pagamentos_recibos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_pagamentos_recibos');
    }
}
