...
class CreateTbDetalhesPagamentosOriginaisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_detalhes_pagamentos_originais', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_detalhes_pagamentos_originais');
    }
}
